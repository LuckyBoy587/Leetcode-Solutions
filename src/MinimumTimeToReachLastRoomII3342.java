...
public class MinimumTimeToReachLastRoomII3342 {
    private static class Solution {
            ...
            while (!pq.isEmpty()) {
                ...
                for (int[] direction : directions) {
                    ...
                    if (newI >= 0 && newI < m && newJ >= 0 && newJ < n) {
                        int newReachTime = Math.max(curr.time, moveTime[newI][newJ]) + curr.step;
                        if (newReachTime < reachTime[newI][newJ]) {
                            reachTime[newI][newJ] = newReachTime;
                            pq.offer(new Position(newI, newJ, 3 - curr.step, newReachTime));
                        }
                    }
                }
            }
        ...
        static class Position {
            ...
            public Position(int i, int j, int step, int time) {
                this.i = i;
                this.j = j;
                this.step = step;
                this.time = time;
